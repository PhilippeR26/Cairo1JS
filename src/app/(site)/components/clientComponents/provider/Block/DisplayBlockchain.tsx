...
import { useStoreServer } from "../serverContext";
...
import * as constants from '@/app/type/constants';
import { getBlockBackend, getChainIdBackend } from '@/app/(site)/server/provider/backendProvider';
...
export default function DisplayBlockChain() {
    ...
    const providerServer = useStoreServer(state => state.providerServer);
