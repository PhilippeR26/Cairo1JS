...
export default function PlayWithCairo1() {
    ...
    const [cairo1Contract, setCairo1Contract] = useState<Contract | undefined>();
    ...
    useEffect(() => {
        console.log("ZZZ");
        console.log("ZZZ-walletAccountFromContext =", walletAccountFromContext);
        if (!!cairo1Contract) {
            console.log("ZZZ-provider", cairo1Contract.providerOrAccount);
