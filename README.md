...
## local node
If you want to test the App using a local node, you will have CORS problems.  
You can use with Brave:
```bash
flatpak run com.brave.Browser --disable-web-security --user-data-dir="$HOME/brave-dev"
# or
brave-browser --disable-web-security --user-data-dir="$HOME/brave-dev"
```
